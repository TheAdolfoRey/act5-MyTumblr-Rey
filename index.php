<?php
session_start();
$acc_username = "Adolforey";
$acc_password = "Adolforey3";
$acc_fullname = "Adolfo III Rey";
$acc_address = "Brgy.Uno, Poblacion, Buenavista, Marinduque";
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
		      		...
		      		<div class="form-group">
						  ...
						  if(isset($_REQUEST['notexist']) === true){
							...
							echo "<div class='alert alert-warning' role='alert'> You are still logged in. Please <a href='account.php'> click here to proceed...<a/> </div>";
						} 
